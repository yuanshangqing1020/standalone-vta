...
本目录提供两个 Jupyter Notebook，旨在讲解 standalone-vta 的使用方法，并演示 `standalone-vta/src/compiler/vta_compiler` 中的数据生成与处理流程，以供 `standalone-vta/src/simulators` 使用。

- [教程 1：数据定义（data_definition）](https://mybinder.org/v2/gh/onera/standalone-vta/main?urlpath=%2Fdoc%2Ftree%2Ftutorials%2Ftutorial1_data_definition.ipynb)
- [教程 2：操作定义（operations_definition）](https://mybinder.org/v2/gh/onera/standalone-vta/main?urlpath=%2Fdoc%2Ftree%2Ftutorials%2Ftutorial2_operations_definition.ipynb)
